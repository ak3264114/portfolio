      ...
      <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-800/60 p-6 rounded-xl border border-gray-700">
          ...
          <div className="space-y-4">
            ...
            <div>
              <h3 className="text-blue-400">CodeStrike</h3>
              <p className="text-sm text-gray-400">Software Developer Intern • Nov 2022-Feb 2023</p>
              <p className="text-sm text-gray-300 mt-1">Created UI for profile page, improved UX</p>
            </div>
          </div>
        </div>
      </motion.div>
